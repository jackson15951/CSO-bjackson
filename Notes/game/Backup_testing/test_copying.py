        ...
        for event in events:
            if event.type == pygame.MOUSEBUTTONUP:
                if self.rect.collidepoint(event.pos):
                    ...
                    if x == 48 and y == 250: screen_size(), game(oprandom, optimed, opclicks) # Normal
...
# Sprites Main Menu
sprcords = ((48, 250), (158, 250), (268, 250), (49, 350), (159, 350), (269, 350)) # normal, easy, hard, timed, random, max-clicks
sprites_menu = [ClickableSprite(pygame.Surface((100, 40)), cord[0], cord[1], BLACK) for cord in list(sprcords)]
