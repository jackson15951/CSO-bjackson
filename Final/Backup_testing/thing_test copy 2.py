        ...
        for event in events:
            if event.type == pygame.MOUSEBUTTONUP:
                if self.rect.collidepoint(event.pos):
                    ...
                    if x == 49 and y == 250: game(False, 0) # Normal 
                    if x == 49 and y == 300: game(True, 0) # Random
                    if x == 49 and y == 350: game(False, 1) # Timed
                    if x == 49 and y == 400: game(False, 2) # Max clicks
                    if x == 159 and y == 250: expand_cords(2,2), game(False, 0) # Easy 
                    if x == 269 and y == 250: expand_cords(9,6), game(False, 0) # Hard
...
sprnorm = ClickableSprite(pygame.Surface((100, 40)), 49, 300, BLACK) # random
...
sprmaxclicks = ClickableSprite(pygame.Surface((100, 40)), 49, 400, BLACK) # max clicks
...
def main():
    ...
    while exit: 
        ...
        screen.blit(text_norm , (63,260)) 
        screen.blit(text_random , (63,310))
        screen.blit(text_timed , (63,360))
        screen.blit(text_maxclicks , (55,410))
